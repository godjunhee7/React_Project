...
const [sortType, setSortType] = useState("서명순");
const [NextOrder, setNextOrder] = useState("오름차순");
...
else if(formData.selectedCheckboxes.length == 0){
// console.log("checkbox: " + formData.selectedCheckboxes);
window.alert("검색할 자료유형이 설정이 안되었습니다.");
navigate("../Detail");
}

else if(formData.selectedCheckboxes.includes("전체")){
window.alert("서비스 준비 중입니다.");
navigate("../Detail");
}

else if(formData.selectedCheckboxes.length > 1){    // 자료유형 2개 이상 선택한 경우
// console.log("checkbox: " + formData.selectedCheckboxes);
window.alert("서비스 준비 중입니다.");
navigate("../Detail");
}
...
// const uniqueBooks = getUniqueBooks(result);
                                      ...
                                      {showDetail[book.id] && (
                                          <div>
                                              <table>
                                                  ...
                                                  <tr>
                                                      <td className={`loan ${book.loan_status === '대출 가능' ? 'available' : 'loaned'}`}>{book.loan_status}</td>
